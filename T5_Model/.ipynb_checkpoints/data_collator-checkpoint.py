...
class T2TDataCollator():
    '''Custom Data collator that will be used to instantiate the pytorch dataloader'''
    def __init__(self, tokenizer, mode='training', using_tpu=False):
        self.tokenizer = tokenizer
        self.mode = mode
        self.using_tpu = using_tpu

    def __call__(self, batch: List[Union[List[int], torch.Tensor, Dict[str, torch.Tensor]]]) -> Dict[str, torch.Tensor]:
        """
